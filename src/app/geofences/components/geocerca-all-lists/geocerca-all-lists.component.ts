...
@Component({
  selector: 'app-geocerca-all-lists',
  templateUrl: './geocerca-all-lists.component.html',
  styleUrls: ['./geocerca-all-lists.component.scss']
})

export class GeocercaAllListsComponent implements OnInit {
