...
@Component({
  selector: 'app-geocerca-all-add',
  templateUrl: './geocerca-all-add.component.html',
  styleUrls: ['./geocerca-all-add.component.scss']
})


export class GeocercaAllAddComponent implements OnInit, OnDestroy  {
